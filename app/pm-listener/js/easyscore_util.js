...
var EasyScoreUtil = function() {
  ...
  this.notateExercise = function() {
	...
	this.notateExercise_old = function() {
        ...
        var vfStave = curVf.Stave().addClef('percussion')
        var vfVoices = []
        ...
        console.log("About to format voices:")
        console.log(curVf.getVoices())
        curVf.Formatter().joinVoices(vfVoices).formatToStave(curVf.getVoices(), vfStave);

				//create the measure and connect all the groups with the reduce(concat) function
				//var stave = system.addStave(vfStave)
